...
public class NodeFarrell {
	 ...
	 */
	private PokemonCardFarrell myData;
	/**
	 ...
	 */
	public NodeFarrell(PokemonCardFarrell newData) {
		myData = newData;
		myNext = null;
	}//Node
	 ...
	 */
	public NodeFarrell(PokemonCardFarrell newData, NodeFarrell newNext) {
		myData = newData;
		myNext = newNext;
	}//NodeFarrell
	 ...
	 */
	public PokemonCardFarrell getData() {
		return myData;
	}//getPokemon
	 ...
	 */
	public void setData(PokemonCardFarrell newPoke) {
		myData = newPoke;
	}//setPokemon
